...
const CategoryBrandController = require("../controllers/customer/Category-BrandController");
...
router.get("/categories/", CategoryBrandController.getAllCategory);
router.get(
  "/categories/:category_id",
  CategoryBrandController.getProductCategory
);
router.get(
  "/brands/:brand_id",
  CategoryBrandController.getProductBrand
);
